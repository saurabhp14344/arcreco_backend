...
from .views import UserCreateAPIView, UserProfileChangeAPIView, ChangeProfilePictureView, UserProfileView, UserAddAPIView, ChangePasswordView, CompanyLogoView, TokenObtainPairPatchedView, GetUserByAdminView
...
urlpatterns = [
    ...
    path(r'get_user', GetUserByAdminView.as_view()),
    ...
    path('login/', TokenObtainPairPatchedView.as_view()),

...
class TotalReconcile(models.Model):
    ...
    reconcile_t1 = models.IntegerField(null=True, blank=True)
    reconcile_t2 = models.IntegerField(null=True, blank=True)
    reconcile_t3 = models.IntegerField(null=True, blank=True)
    settlement_amount = models.IntegerField(null=True, blank=True)
    bank_amount = models.IntegerField(null=True, blank=True)
    open_amount = models.IntegerField(null=True, blank=True)

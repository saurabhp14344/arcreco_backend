...
class TotalReconcile(models.Model):
    ...
    reconcile_count = models.IntegerField(default=0)
    ageing_count = models.IntegerField(default=0)
    reconcile_t1 = models.IntegerField(default=0)
    reconcile_t2 = models.IntegerField(default=0)
    reconcile_t3 = models.IntegerField(default=0)
    settlement_amount = models.FloatField(default=0.0)
    bank_amount = models.FloatField(default=0.0)
    open_amount = models.FloatField(default=0.0)
